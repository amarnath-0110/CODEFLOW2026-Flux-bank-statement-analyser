...
import { isRegExp as x, isFileEntry as o, isBlobOrFile as f, isDirectoryEntry as h, isString as r, isArray as E, isFunction as a } from "../utils/test.js";
...
function S(t) {
  ...
  const i = (r(t) ? t.split(",") : E(t) ? t : []).map((n) => {
    ...
    if (n.endsWith("*") || /^(audio|video|image|text)$/.test(n)) {
      const s = n.split("/")[0];
      return (p) => o(p) && f(p.file) && p.file.type.toLowerCase().startsWith(s);
    }
...
export {
  ...
  q as whenEntryHasAction,
  L as whenEntryIs,
  z as whenEntryNotHasStatus
};
