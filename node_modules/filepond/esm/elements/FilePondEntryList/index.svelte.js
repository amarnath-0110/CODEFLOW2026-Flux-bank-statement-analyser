...
import { from_html as we, append as Me } from "../../svelte/svelte/src/internal/client/dom/template.js";
...
import { delegate as Pe, event as _e, delegated as St } from "../../svelte/svelte/src/internal/client/dom/elements/events.js";
...
function qr(wt, i) {
  ...
  function G(t, r, d) {
    if (!t)
      return;
    const { stagger: v, oncomplete: p, retain: M = !1 } = d ?? {};
    if (!e(W)) {
      p && p();
      return;
    }
  ...
  k(() => {
    ...
    const F = !tt($(b(() => e(z)), Ot()), M), C = e(w).x !== 0 || e(w).y !== 0, Q = {
      searchBounds: e(Vt),
      cacheClientRectangles: C ? 0 : 250
    }, P = Le(V, p), x = F ? pt : r ? tr(r, M, P, Q) : er(e(m), M, P, Q);
    if (r && x > -1) {
  ...
  return Ge(D, (t) => n(m, t), () => e(m)), Y(D, () => Rt({ onmeasure: ye })), Y(D, () => Ne({
    ...
    ondragitemout: me,
    ondropitem: vt
  })), Te(() => ke(xe, e(he))), Dt("innerWidth", (t) => n(dt, t, !0)), Dt("innerHeight", (t) => n(ut, t, !0)), St("keydown", D, ve), St("keyup", D, be), Me(wt, D), Ae(Se);
}
Pe(["keydown", "keyup"]);
export {
  qr as default
