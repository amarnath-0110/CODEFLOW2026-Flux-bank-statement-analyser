...
* https://filepond.com
*/
import { blobToFile as A } from "../utils/file.js";
import { getImageSize as B } from "../utils/media.js";
import { rectApply as M, rectFromSize as S } from "../utils/rect.js";
  ...
  factory: ({ props: v, extensionName: z }) => ({
    ...
    transformEntry: async (o, { signal: c }) => {
      const {
        ...
        type: I,
        workersURL: R
      } = v, { file: s } = o, x = [...o.extension[z].history ?? []], h = await B(s);
      if (h === null || k(h))
        throw "Failed to read image size";
      const e = M(S(h, f), Math.round);
      let t = q(e);
      if (d || l) {
