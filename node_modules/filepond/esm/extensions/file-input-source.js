...
const w = g({
  ...
  factory: ({ didSetProps: f }, m) => {
    const { insertEntries: p, removeEntries: a } = m;
    let n;
    return f(({ element: r, resetFilesOnAdd: l, insertIndex: i }) => {
      if (!r)
        return;
      const e = c(r);
      ...
      function o() {
        ...
        t = s, p(s, i > -1 ? i : void 0), l && (e.files = new DataTransfer().files);
      }
